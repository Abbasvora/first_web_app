...
@users.route('/regestration', methods=['GET', 'POST'])
def regestration():
...
def account():
    ...
    if form.validate_on_submit():
        ...
        db.session.commit()
        flash('Your account has been upated!', 'success')
...
def user_posts(username):
    ...
    return render_template('user_post.html', posts=posts, user=user)  # returns string to home page
